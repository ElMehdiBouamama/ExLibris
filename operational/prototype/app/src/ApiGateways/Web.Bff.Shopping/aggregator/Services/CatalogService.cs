...
public class CatalogService : ICatalogService
{
    ...
    private CatalogItem MapToCatalogItemResponse(CatalogItemResponse catalogItemResponse)
    {
        return new CatalogItem
        {
            ...
            NumberOfLines = catalogItemResponse.NumberOfLines,
            Brand = catalogItemResponse.CatalogBrand.Name,
            Dimensions = catalogItemResponse.CatalogDimension.Dimensions.ToArray(),
            Shape = catalogItemResponse.CatalogShape.Shape
        };
    }
}
