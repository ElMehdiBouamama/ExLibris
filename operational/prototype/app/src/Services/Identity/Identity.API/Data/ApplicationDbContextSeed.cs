namespace Microsoft.eShopOnContainers.Services.Identity.API.Data
{
    ...
    public class ApplicationDbContextSeed
    {
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            new ApplicationUser()
            {
                CardHolderName = "El Mehdi Bouâmama",
                CardNumber = "4012888888881881",
                CardType = 1,
                City = "Casablanca",
                Country = "Morocco",
                Email = "elmehdi.bouamama@gmail.com",
                Expiration = "12/23",
                Id = Guid.NewGuid().ToString(),
                LastName = "Bouamama",
                Name = "ElMehdi",
                PhoneNumber = "00212697160265",
                UserName = "elmehdi.bouamama@gmail.com",
                ZipCode = "21100",
                State = "Casa-Settat",
                Street = "51, rue pierre parents",
                SecurityNumber = "421",
                NormalizedEmail = "ELMEHDI.BOUAMAMA@GMAIL.COM",
                NormalizedUserName = "ELMEHDI.BOUAMAMA@GMAIL.COM",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };

            user.PasswordHash = _passwordHasher.HashPassword(user, "Alabasta7*7");
