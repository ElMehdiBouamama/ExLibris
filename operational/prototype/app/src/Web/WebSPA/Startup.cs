...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            options.AddPolicy(name: "AllowLocalHostDev",
                              policy =>
                              {
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory, IAntiforgery antiforgery)
    {
        ...
        app.UseSpa(spa =>
        {
            ...
            if (env.IsStaging())
            {
                // use the SpaServices extension method for angular, that will make the application to run "ng build" for us, when in development.
                spa.UseAngularCliServer(npmScript: "build:prod");
            }
        });
    }
